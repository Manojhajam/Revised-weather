...
// import {AuthContext} from "../context/WeatherContext";
  ...
  return (
    <div className="current flex gap-4 p-6 items-stretch text-black mt-5">
      ...
      <div className="Undercurrent p-4 rounded-2xl border border-gray-900 w-54 text-center flex flex-col justify-center">
        ...
        <p className="text-4xl font-semibold">{Math.round(temperature)}{UNITS[units].temperature }</p>
        <p className="text-sm mt-1">feels like {UNITS[units].temperature}</p>
