...
const Modal = ({children, open, onClose, title=""}) => {
  return (
      <>
          {open && (
              <div className='fixed inset-0 w-screen h-screen bg-gray-500/30 background-blur-[1px] flex justify-center overflow-y-auto p-4'>
                  <div className="card m-auto w-[400px] p-4 bg-white animate-bounce-short  px-8 py-5 shadow-lg border border-gray-400  rounded-lg">
